...
-- Dumping data for table newcms.menu: ~3 rows (approximately)
/*!40000 ALTER TABLE `menu` DISABLE KEYS */;
INSERT INTO `menu` (`id`, `name`, `layout`, `ordering`) VALUES
	(2, 'home menu', 'home_menu', 2),
	(3, 'footer menu', 'footer_menu', 3),
	(6, 'TOP MENU', 'top_menu', 1);
...
INSERT INTO `page` (`id`, `title`, `menu_id`, `order`, `parent`, `is_home`, `publish`, `layout`, `protected`, `created_by`, `created_at`, `updated_at`) VALUES
	(1, '', 2, 0, 0, 1, 1, NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
-- Dumping data for table newcms.page_lang: ~2 rows (approximately)
...
INSERT INTO `page_lang` (`lang`, `page_id`, `url`, `title`, `subtitle`, `nav_title`, `meta_title`, `meta_description`, `meta_keywords`, `online`) VALUES
	('en', 1, 'in-english', 'in english', 'english', 'english menu', 's', 's', 's', 1),
	('id', 1, 'in-indonesia', 'in indonesia', 'Indonesia', 'Indonesia', 'xx', 'xx', 'xx', 1);
...
CREATE TABLE IF NOT EXISTS `sections` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `sub_titile` varchar(255) NOT NULL,
...
-- Dumping data for table newcms.sections: ~0 rows (approximately)
...
INSERT INTO `users` (`id`, `username`, `email`, `first_name`, `last_name`, `password`, `last_login`, `active`, `admin`) VALUES
	(1, 'admin', 'admin@admin.com', 'Admin', 'istrator', '$2a$08$djBBTkVNaG9LWUdydEdYceKxtn6KDzjZa99Jq0myYVG1jOWg0huBS', '0000-00-00 00:00:00', 1, 1),
	(2, 'hafidz', '', '', '', '$2kgShZfWTHjs', '0000-00-00 00:00:00', 0, 0);
