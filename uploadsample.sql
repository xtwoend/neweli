...
-- Dumping data for table newcms.page: ~17 rows (approximately)
...
-- Dumping data for table newcms.page_lang: ~34 rows (approximately)
...
-- Dumping data for table newcms.section_lang: ~11 rows (approximately)
/*!40000 ALTER TABLE `section_lang` DISABLE KEYS */;
INSERT INTO `section_lang` (`section_id`, `lang`, `title`, `subtitle`, `content`) VALUES
	(2, 'en', 'b', 'b', '<h2>tentang kami</h2>\r\n\r\n<p>bootstrap-wysihtml5 is a javascript plugin that makes it easy to create simple, beautiful wysiwyg editors with the help of&nbsp;<a href="https://github.com/xing/wysihtml5" target="_blank">wysihtml5</a>&nbsp;and&nbsp;<a href="http://twitter.github.com/bootstrap/" target="_blank">Twitter Bootstrap</a></p>\r\n'),
