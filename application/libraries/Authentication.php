...
class Authentication {
	...
	public function get_fullname($user_identifier = false)
	{
		if(!$user_identifier) $user_identifier = $this->ci->session->userdata('identifier');

		$user = $this->ci->db->where('id', $user_identifier)->get($this->user_table)->row();
